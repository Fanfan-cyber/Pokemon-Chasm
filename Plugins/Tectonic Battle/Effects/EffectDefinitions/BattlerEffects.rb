...
GameData::BattleEffect.register_effect(:Battler, {
    ...
    :is_mental => true,
    :apply_proc => proc do |battle, battler, _value|
        battle.pbDisplay(_INTL("{1} was subjected to torture!", battler.pbThis))
    end,
})
...
GameData::BattleEffect.register_effect(:Battler, {
    ...
    :apply_proc => proc do |battle, battler, value|
        battle.pbAnimation(:CHARGE, battler, nil, 0)
...
GameData::BattleEffect.register_effect(:Battler, {
    ...
    :real_name => "Relentless Pursuit",
    :info_displayed => false,
})

GameData::BattleEffect.register_effect(:Battler, {
    :id => :ForceBaseDamage,
    :real_name => "Force Base Damage",
    :type => :Integer,
    :info_displayed => false,
    :resets_battlers_eot => true,
})