class PokeBattle_Battle
    ...
    def pbPursuit(idxSwitcher)
        @switching = true
        pbPriority.each do |b|
            next unless b.can_relentless_pursuit?
            next if b.fainted? || !b.opposes?(idxSwitcher) # Shouldn't hit an ally
            b.applyEffect(:RelentlessPursuit)
            forceUseMove(b, :PURSUIT, idxSwitcher, ability: :RELENTLESSPURSUIT, forceBaseDamage: 30)
            b.disableEffect(:RelentlessPursuit)
