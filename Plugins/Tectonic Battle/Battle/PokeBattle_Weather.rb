class PokeBattle_Battle
    ...
    def weatherSpedUp?
        return true if eclipsed? && (pbCheckGlobalAbility(:EPHEMERATE) || curseActive?(:CURSE_BOOSTED_ECLIPSE))
        return true if moonGlowing? && (pbCheckGlobalAbility(:SOLSTICE) || curseActive?(:CURSE_BOOSTED_MOONGLOW))
        return false
    end
