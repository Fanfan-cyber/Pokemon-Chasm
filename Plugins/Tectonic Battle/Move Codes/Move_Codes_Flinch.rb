...
#===============================================================================
# An attack that hits first and makes the target flinch. It fails if the target
# is not readying a priority move.(Upper Hand)
#===============================================================================
class PokeBattle_Move_FlinchTargetFailsIfTargetNotUsingPriorityMove < PokeBattle_FlinchMove
    def pbMoveFailed?(user, targets, show_message)
        priority = targets.any? { |target| (@battle.choices[target.index][4] || 0) > 0 }
        unless priority
