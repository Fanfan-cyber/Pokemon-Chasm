...
alias getLeechedEffectScore getLeechEffectScore
...
def predictedEOTDamage(battle,battler)
    ...
    # Pain Presence
    damage += battler.getFractionalDamageAmount(NOXIOUS_DAMAGE_FRACTION, aggravate: aggravate) if battle.pbCheckOtherAbility(:NOXIOUS, battler.index) && !battler.pbHasType?(:POISON)
