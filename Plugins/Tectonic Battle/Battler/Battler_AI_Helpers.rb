class PokeBattle_Battler
    ...
    def aiSeesMove(move) # don't need to see anymore
    ...
    def eachAIKnownMove # knows all moves
    ...
    def eachAIKnownMoveWithIndex # knows all moves
        return if movesHiddenByIllusion?
        #knownMoveIDs = @battle.aiKnownMoves(@pokemon)
    ...
    def aiLearnsAbility(abilityID) # don't need to learn anymore
    ...
    def aiKnowsAbility?(checkAbility)
        return true # always knows all abilities
    ...
    ###############################################################################
    def aiLearnsItem(itemID) # don't need to learn anymore
        #@battle.aiLearnsItem(self,itemID)
    end

    def aiKnowsItem?(checkItem)
        return true # always knows all items
        return true unless pbOwnedByPlayer?
