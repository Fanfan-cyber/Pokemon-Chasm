...
CDKey.register_other_key(:tectonic, true)
CDKey.register_other_key([:disabletectonic, :tectonic], false)
...
CDKey.register_other_key(:storymode, true)
CDKey.register_other_key([:nostorymode, :storymode], false)
