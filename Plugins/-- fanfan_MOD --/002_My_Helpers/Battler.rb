class PokeBattle_Battler
  def can_relentless_pursuit?
    return false unless hasActiveAbility?(:RELENTLESSPURSUIT)
    #return false unless @hp >= @totalhp / 2
    return true
  end
  ...
  def party_most_type
    return @battle.player_most_type unless opposes?
    return @battle.opposing_most_type
  end
