DOCK_LOCATIONS = {
    :CASABA_VILLA_DOCK => {
        :map_name => _INTL("Casaba Villa"),
        :map_id => 136,
        :event_id => 39,
    },
    :FEEBAS_FIN => {
        :map_name => _INTL("Feebas' Fin"),
        :map_id => 59,
        :event_id => 24,
    },
    :ELEIG_BOATING_DOCK => {
        :map_name => _INTL("Eleig Boating Dock"),
        :map_id => 185,
        :event_id => 5,
        :unlock_switch => 301,
    },
    :SWEETROCK_DOCK => {
        :map_name => _INTL("Sweetrock Harbor"),
        :map_id => 217,
        :event_id => 57,
        :unlock_switch => 302,
    },
    :TAPU_ISLAND => {
        :map_name => _INTL("Guardian Island"),
        :map_id => 377,
        :event_id => 93,
        :unlock_switch => 303,
    },
    :EVENTIDE_ISLE => {
        :map_name => _INTL("Eventide Isle"),
        :map_id => 413,
        :event_id => 13,
        :unlock_switch => 304,
    },
    :DRAGON_ISLAND => {
        :map_name => _INTL("Isle of Dragons"),
        :map_id => 356,
        :event_id => 38,
        :unlock_switch => 86,
    },
    :TRI_ISLAND => {
        :map_name => _INTL("Tri Island"),
        :map_id => 411,
        :event_id => 23,
        :unlock_switch => 97,
    },
    :MONUMENT_ISLAND => {
        :map_name => _INTL("Battle Monument"),
        :map_id => 357,
        :event_id => 4,
        :unlock_switch => 99,
    },
    :SPIRIT_ATOLL => {
        :map_name => _INTL("Spirit Atoll"),
        :map_id => 182,
        :event_id => 19,
        :unlock_switch => 151,
    },
...
def unlockBoatingSpot(dockID,ignoreAlreadyActive=false)
    ...
    pbMessage(_INTL("\\wm{1}\\me[Slots win]\\wtnp[80]\1", text))
